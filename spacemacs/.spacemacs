...
values."
  ...
  (setq-default
   ...
   ;; The theme of the mode line. One of `spacemacs', `all-the-icons', `custom',
   ;; `vim-powerline', `vanilla'.
   ;; TODO: Change the separator whenever that's fixed
...
you should place your code here."
  ...
  ;; Workaround to (void-variable seq-random-elt) error
  (require 'seq)

  ;; Set the window size management
                                        ;(golden-ratio-mode 1)

  ;; Set j and k to move correctly on wrapped lines
  (define-key evil-normal-state-map (kbd "j") 'evil-next-visual-line)
  (define-key evil-normal-state-map (kbd "k") 'evil-previous-visual-line)

  (spacemacs/toggle-highlight-current-line-globally-off)
  ;;(spacemacs/toggle-highlight-indentation-off)
  ;;(spacemacs/linum-relative-toggle)

  ;; Setup cider for clojure
  ...
  ;; Show a full document preview
  (add-hook 'doc-view-mode-hook 'auto-revert-mode)

  (with-eval-after-load 'org)

  ;; Setup default references path
  (setq reftex-default-bibliography '("~/refs/references.bib"))

  ;; Tell Auctex to ask for a master file
  ...
  ;; Stop rust being slow when opening large files
  ;; https://github.com/rust-lang/rust-mode/issues/288#issuecomment-478228708
