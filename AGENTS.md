...
Never manually edit `.lua` files in `cfg/nvim/` that have a corresponding `.fnl` file. These are auto-generated by nfnl from Fennel source. Only edit the `.fnl` files.
