...
(local prompts
  {"nvim-lua" "In nvim, using lua:"
   "expert" ["Write in the style and quality of an expert in {{}} with 20+ years of experience and multiple PHDs."
             "Prioritize unorthodox, lesser known advice in your answer."
             "Explain using detailed examples, and minimize tangents and humor."]})

(local visual-prompts
  {"nvim-lua" "You are an expert in lua with extensive experience in neovim's lua api and how it integrates with the vim api."
   "summarise" "Summarise the given text in 1-2 lines."
   "doc string" ["Output a docstring in a codeblock for the given code."
                 "Do not output the code as well, just the docstring"]
   "clarity suggestions" ["Output a bullet point list of suggestions to improve clarity."
