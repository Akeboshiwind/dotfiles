...
return {{"neovim/nvim-lspconfig", opts = {servers = {clojure_lsp = {init_options = {["cljfmt-config-path"] = (vim.fn.stdpath("config") .. "/config/.cljfmt.edn")}}}}}, {"PaterJason/cmp-conjure", dependencies = {"hrsh7th/nvim-cmp"}}, {"eraserhd/parinfer-rust", build = "cargo build --release"}, {"folke/which-key.nvim", opts = {defaults = {["<leader>l"] = {name = "log"}, ["<leader>e"] = {name = "eval"}, ["<leader>c"] = {name = "display as comment"}, ["<leader>g"] = {name = "goto"}, ["<leader>G"] = {name = "git"}, ["<leader>v"] = {name = "view"}, ["<leader>s"] = {name = "session"}, ["<leader>t"] = {name = "test"}, ["<leader>r"] = {name = "refresh"}}}}, {"Olical/conjure", tag = "v4.50.0", dependencies = {"nvim-telescope/telescope.nvim", "eraserhd/parinfer-rust", "PaterJason/cmp-conjure"}, opts = {config = {["mapping#prefix"] = "<leader>", ["highlight#enabled"] = true, filetypes = {"clojure", "fennel"}, ["client#clojure#nrepl#mapping#session_select"] = false, ["client#clojure#nrepl#connection#auto_repl#enabled"] = false}}, config = _1_}}
