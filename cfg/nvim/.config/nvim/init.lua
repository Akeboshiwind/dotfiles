...
do
  ...
  local function _36_()
    ...
    return vim.api.nvim_create_user_command("G", _37_, {desc = "Open lazygit in current repo root"})
  end
  local function _38_()
...
vim.api.nvim_create_user_command("Tab", _42_, {nargs = 1, desc = "Set tab width for current buffer"})
return nil
